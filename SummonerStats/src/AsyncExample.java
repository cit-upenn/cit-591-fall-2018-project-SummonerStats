...
public class AsyncExample {
	...
	public AsyncExample() throws RiotApiException {
		...
		AsyncRequest requestSummoner = apiAsync.getSummoner(platform, Long.parseLong(summonerId));
		...
		AsyncRequest requestLeague = apiAsync.getLeaguePositionsBySummonerId(platform, Long.parseLong(summonerId));
